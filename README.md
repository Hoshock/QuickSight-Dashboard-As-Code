...
[Claude Code](https://github.com/anthropics/claude-code) や [Kiro](https://github.com/aws/kiro) などの AI コーディングエージェントが QuickSight の Dashboard as Code ワークフローを実行する際に参照するスキルファイル群です。
