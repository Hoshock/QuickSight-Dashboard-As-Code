...
[Claude Code](https://docs.anthropic.com/en/docs/claude-code) や [Kiro](https://kiro.dev) などの AI コーディングエージェントが QuickSight の「ダッシュボード as コード」ワークフローを実行する際に参照するスキルファイル群です。
...
`.claude/skills/` ディレクトリにこのリポジトリの内容を配置します：
